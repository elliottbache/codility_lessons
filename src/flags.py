...
then the distance between any two flags should be greater than or equal
...
def flags_solution(A: list[int]) -> int:
    ...
    Args:
        A (list[int]): an array of integers representing peaks of a
            mountain
    ...
    if peak_positions and max_flags == 1:
        return 1
